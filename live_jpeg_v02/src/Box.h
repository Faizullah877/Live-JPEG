...
#define BOX_TYPE_UUID 0X75756964
	...
	}sj_jumbf_xml_box, * sj_jumbf_xml_box_ptr;
	...
	typedef struct _jumbf_sos_lengths_box
	{
		unsigned int length;
		unsigned int box_type;
		unsigned char* codestream;
		sj_jumbf_box_ptr next;
	} sj_jumbf_sos_lengths_box, * sj_jumbf_sos_lengths_box_ptr;
